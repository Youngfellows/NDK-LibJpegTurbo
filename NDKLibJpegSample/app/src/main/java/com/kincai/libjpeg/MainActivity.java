...
public class MainActivity extends Activity implements OnClickListener {
     ...
     * 图片存放根目录
     */
    private String mImageRootDir = Environment.getExternalStorageDirectory().getPath() + "/jpeg_picture/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageRootDir = getExternalCacheDir().getAbsolutePath();
        Log.i(TAG, "onCreate:: mImageRootDir=" + mImageRootDir);
